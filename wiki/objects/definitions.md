...
- **`ancillaries`**  *(array[[ancillary](ancillary.md)])* - optional  
  **Array item properties:**
  - **`type`**  *(string)* - optional  
    value: "ancillary"
  - **`id`**  *(string)* - **required**  
